...
>你好，我是VictorG，TJU环境科学专业本科生，CS自学选手，热爱计算机科学。

目前是一个热爱CS的技术小白，2022年初开始系统学习编程知识，发现我与CS是相见恨晚，从此励志成为世界知名码农，将自己编写的代码刻在人类发展的里程碑上！
我自学Java以及Java相关开发框架，我不仅有Web开发以及服务端性能优化的经验，同时我也热爱探究底层原理，对Linux的实现，网络通信，体系结构都有研究，除Java之外我也对C和Python也比较熟悉。我曾在京东实习，参与过京东集团大数据相关项目，为京东集团数据中台的建设贡献了绵薄之力，目前决定备战24考研，继续追寻自己的理想！
